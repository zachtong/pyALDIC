...
**Files:** `src/staq_dic/core/pipeline.py`
...
**Files:** `src/staq_dic/gui/widgets/mesh_overlay.py` (NEW)
...
**Files:** `src/staq_dic/gui/panels/canvas_area.py`, `src/staq_dic/gui/app_state.py`
...
**Files:** `src/staq_dic/gui/panels/canvas_area.py`
...
**Files:** `src/staq_dic/core/pipeline.py`, `src/staq_dic/mesh/refinement.py`
