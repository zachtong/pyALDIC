...
from staq_dic.mesh.mark_inside import mark_inside as _real_mark_inside
from staq_dic.mesh.mesh_setup import mesh_setup as _real_mesh_setup
...
def run_with_tracking(
    ...
    with (
        patch(
            "staq_dic.core.pipeline.mesh_setup",
            side_effect=tracker.wrap_mesh_setup,
        ),
        patch(
            "staq_dic.core.pipeline.mark_inside",
