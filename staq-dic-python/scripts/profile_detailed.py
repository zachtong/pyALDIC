"""Detailed per-component profiling of the STAQ-DIC pipeline at ~247K nodes.
...
from staq_dic.strain.nodal_strain_fem import (
...
# ============================================================
print("=" * 72)
print("STAQ-DIC Detailed Profiling - 1024x1024, step=2 (~247K nodes)")
print("=" * 72)
...
from staq_dic.solver.numba_kernels import HAS_NUMBA, icgn_6dof_parallel, icgn_2dof_parallel
if HAS_NUMBA:
