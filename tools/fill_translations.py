...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    'Camera frame rate: %1 fps, from Physical Units.': {
        ...
        'zh_TW': '相機幀率：%1 fps，取自「物理單位」。',
        'ja': 'カメラのフレームレート：%1 fps（「物理単位」の設定）。',
        'ko': "카메라 프레임 속도: %1 fps, '물리 단위'에서 설정.",
        'de': 'Kamera-Framerate: %1 fps, aus „Physikalische Einheiten“.',
        'fr': 'Cadence de la caméra : %1 fps, issue des « Unités physiques ».',
        'es': 'Fotogramas por segundo de la cámara: %1 fps, de «Unidades físicas».',
    },
    'Set the camera frame rate under Physical Units to match by time.': {
        'zh_CN': '请在“物理单位”中设置相机帧率，才能按时间对应。',
        'zh_TW': '請在「物理單位」中設定相機幀率，才能按時間對應。',
        'ja': '時間で対応付けるには、「物理単位」でカメラのフレームレートを設定してください。',
        'ko': "시간으로 맞추려면 '물리 단위'에서 카메라 프레임 속도를 설정하십시오.",
        'de': 'Legen Sie unter „Physikalische Einheiten“ die Kamera-Framerate fest, um nach Zeit zuzuordnen.',
        'fr': 'Définissez la cadence de la caméra dans « Unités physiques » pour associer par le temps.',
        'es': 'Defina los fotogramas por segundo de la cámara en «Unidades físicas» para asociar por tiempo.',
    },
    '(unnamed)': {
        'zh_CN': '（未命名）',
        'zh_TW': '（未命名）',
