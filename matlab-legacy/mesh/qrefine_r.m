function [coordinates,newElements,newIrregular,varargout] ...
    = qrefine_r(coordinates,elements,irregular,varargin)

%qrefine_r: local refinement of quadrilateral mesh by red refinement, 
...
[edge2nodes,irregular2edges,element2edges,...
    ...
    = provide_geometric_data(irregular,elements,varargin{1:end-1});
