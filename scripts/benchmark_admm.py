...
from al_dic.core.data_structures import DICPara, GridxyROIRange, ImageGradients
...
def main() -> None:
    ...
    lit_table = [
        ...
        ("AL-DIC (ours)",      "Numba prange, LOCAL_ICGN",     _our_range(results, "LOCAL_ICGN")),
        ("AL-DIC (ours)",      "Numba+FEM, ADMM 3 iters",      _our_range(results, "ADMM_3ITER")),
    ]
