...
# Ensure al_dic is importable
sys.path.insert(0, str(Path(__file__).resolve().parent.parent / "src"))

from al_dic.core.config import dicpara_default
from al_dic.core.data_structures import GridxyROIRange
from al_dic.core.pipeline import run_aldic
from al_dic.io.image_ops import normalize_images
from al_dic.mesh.criteria import MaskBoundaryCriterion
    ...
    with PdfPages(str(pdf_path)) as pdf:
        ...
        if ref_deform:
            ...
            for mask_label in results:
                ...
                ax = axes[1]
                from al_dic.strain.smooth_field import compute_node_local_spacing
