...
Expected: FAIL — `ModuleNotFoundError: No module named 'al_dic.mesh.criteria.brush_region'`
...
**Files:**
- Create: `src/al_dic/mesh/criteria/brush_region.py`
...
```bash
git add src/al_dic/mesh/criteria/brush_region.py src/al_dic/mesh/criteria/__init__.py
...
**Files:**
- Modify: `src/al_dic/mesh/refinement.py` (add function at bottom, add imports)
- Modify: `src/al_dic/mesh/__init__.py` (add exports)
...
```bash
git add src/al_dic/mesh/refinement.py src/al_dic/mesh/__init__.py
...
|------|--------|-------------|
| `src/al_dic/mesh/criteria/brush_region.py` | **Create** | `BrushRegionCriterion` — marks elements overlapping user-painted regions |
| `src/al_dic/mesh/criteria/__init__.py` | **Modify** | Export `BrushRegionCriterion` |
| `src/al_dic/mesh/refinement.py` | **Modify** | Add `build_refinement_policy()` factory |
| `src/al_dic/mesh/__init__.py` | **Modify** | Export `BrushRegionCriterion` + `build_refinement_policy` |
