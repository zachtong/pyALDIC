...
**Files:**
- Modify: `src/al_dic/io/image_ops.py:67-122`
...
**Files:**
- Modify: `src/al_dic/core/pipeline.py:489-496` (ref image setup)
- Modify: `src/al_dic/core/pipeline.py:~530` (precompute_subpb1 call)
- Modify: `src/al_dic/core/pipeline.py:~560` (local_icgn call)
...
**Files:**
- Modify: `src/al_dic/solver/icgn_batch.py:24-150`
...
**Files:**
- Modify: `src/al_dic/solver/icgn_batch.py:153-286` (2-DOF precompute)
...
**Files:**
- Modify: `src/al_dic/solver/numba_kernels.py:~600-840`
...
**Files:**
- Modify: `src/al_dic/solver/subpb1_solver.py:31-65, 68-162`
- Modify: `src/al_dic/solver/local_icgn.py:~20-90`
...
**Files:**
- Modify: `src/al_dic/core/data_structures.py` (DICPara)
- Modify: `src/al_dic/core/config.py` (default value)
