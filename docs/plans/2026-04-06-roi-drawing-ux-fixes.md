...
Edit `src/al_dic/gui/app.py` `_on_roi_edit_for_frame`:
...
```bash
git add tests/test_gui/test_roi_drawing_ux.py src/al_dic/gui/app.py
...
- Modify: `src/al_dic/gui/app.py` (`_on_draw_requested`)
...
**Files:**
- Modify: `src/al_dic/gui/app_state.py` (remove field, update `_init_state`, `set_image_files`)
- Modify: `src/al_dic/gui/app.py` (replace all reads with `state.current_frame`)
- Modify: `src/al_dic/gui/panels/canvas_area.py` (replace all reads)
...
- `src/al_dic/gui/app_state.py` — field declaration + `set_image_files` reset
- `src/al_dic/gui/app.py` — `_on_roi_clear`, `_on_roi_import`, `_on_roi_invert`
  (no longer in `_on_roi_edit_for_frame` after Task 1)
- `src/al_dic/gui/panels/canvas_area.py` — 3 reads at lines 483, 729, 765
...
```bash
git add src/al_dic/gui/app_state.py src/al_dic/gui/app.py \
        src/al_dic/gui/panels/canvas_area.py \
...
**Files:**
- Modify: `src/al_dic/gui/panels/canvas_area.py` (`update_roi_overlay`)
...
```bash
git add src/al_dic/gui/panels/canvas_area.py tests/test_gui/test_roi_drawing_ux.py
...
**Files:**
- Modify: `src/al_dic/gui/app.py` (connect `current_frame_changed`)
...
```bash
git add src/al_dic/gui/app.py tests/test_gui/test_roi_drawing_ux.py
...
class TestQ4_MeshDuringEditing:
    def test_roi_editing_routes_to_preview_mesh(self, qapp, monkeypatch):
        ...
        """
        from al_dic.gui.panels import canvas_area as ca_module
...
**Files:**
- Modify: `src/al_dic/gui/panels/canvas_area.py` (`_refresh_mesh_overlay`)
...
Edit `src/al_dic/gui/panels/canvas_area.py` `_refresh_mesh_overlay` (line ~923):
...
**Files:**
- Modify: `src/al_dic/gui/widgets/image_list.py` (`_delete_selected`)
...
```bash
git add src/al_dic/gui/widgets/image_list.py tests/test_gui/test_roi_drawing_ux.py
...
| File                                                       | Type    | Changes                                                                            |
|------------------------------------------------------------|---------|------------------------------------------------------------------------------------|
| `src/al_dic/gui/app_state.py`                            | edit    | drop `roi_editing_frame` field                                                     |
| `src/al_dic/gui/app.py`                                  | edit    | new `_load_roi_buffer_for_current_frame`, frame-sync in `_on_roi_edit_for_frame`, signal wiring for buffer reload |
| `src/al_dic/gui/panels/canvas_area.py`                   | edit    | `update_roi_overlay` reads `per_frame_rois`, `_refresh_mesh_overlay` Q4+Q5 routing |
| `src/al_dic/gui/widgets/image_list.py`                   | edit    | `_delete_selected` clears results                                                  |
