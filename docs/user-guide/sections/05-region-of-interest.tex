...
\begin{description}[leftmargin=1.2cm,style=nextline]
  ...
  \item[Cut $\blacktriangledown$]
    Same menu as Add, but the drawn region is subtracted (AND-NOT)
    from the Region of Interest mask. Use this to cut holes around
    features you don't want to track (bubbles, voids, damaged
    areas).
